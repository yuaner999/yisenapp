...
//		var equipment_component_id =$("select").eq(2).find("option:selected").attr("name");
		...
		'"emp_name":"'+userName+'","report_create_man":"'+userName+'","num":"'+num+'"}';
//		console.log(jsonData);
//		console.log(typeof jsonData);
		var ajax = $.ajax({
			type: "post",
			url: url + "/handler/Maintain.asmx/SaveSelectedInfo?jsoncallback?",
			dataType: "jsonp",
			jsonp: 'jsoncallback',
			data: {
				"tokenId": newTokenId,
...
//	        				window.location ="orderTime.html?type=0&id="+ data.result ;
	        			});
	        		},1314);
