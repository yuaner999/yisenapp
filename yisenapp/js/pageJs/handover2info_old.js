...
//	console.log(endDate);
		var ajax = $.ajax({
        type: "post",
        url: url+"/handler/Handover.asmx/GetHandoverListInfo2?jsoncallback?",
        dataType: "jsonp",
        jsonp: 'jsoncallback',
        data: { 
			"tokenId":tokenId,
...
// 				}
 					...
 					str +='<li>'+
							...
							'<p>交班人：<span>'+json[i].handover_man_before+'</span></p>'+
							'<p>接班人：<span>'+json[i].handover_man_after+'</span></p>'+
							'<div class="btnn"><a href="handover_homepg2.html?type=0&id='+json[i].handover_id+'">查看详情</a></div>'+
						 '</li>';
					...
					str +='<li>'+
 					...
 					str +='<li>'+
							'<p> 交班时间<span>'+hour+'</span><span>'+day+'</span></p>'+
							'<ol>'+
								'<li><a>接班状态：</a><span class="no_ok">未提交</span></li>'+
								'<li><a>现场名称：</a><span>'+json[i].scene_name+'</span></li>'+
							'</ol>'+
							'<p>交班人：<span>'+json[i].handover_man_before+'</span></p>'+
							'<p>接班人：<span>'+json[i].handover_man_after+'</span></p>'+
							'<div class="btnn"><a href="handover2.html?handoverid='+json[i].handover_id+'">修改</a></div>'+
						 '</li>';
 				}
 			}
